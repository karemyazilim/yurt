...
export const UpdateRedis = ({ redisId }: Props) => {
	...
	const onSubmit = async (formData: UpdateRedis) => {
		await mutateAsync({
			...
			.then(() => {
				toast.success("Redis başarıyla güncellendi");
			...
			.catch(() => {
				toast.error("Redis güncellenirken hata oluştu");
			})
			.finally(() => {});
	};
	...
	return (
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<DialogContent className="sm:max-w-lg">
				<DialogHeader>
					<DialogTitle>Redis Düzenle</DialogTitle>
					<DialogDescription>Redis verilerini güncelle</DialogDescription>
				</DialogHeader>
